        ...
        <div className="font-body-md text-body-md text-[#191c1e] min-h-screen relative z-0">
            ...
            <nav className="fixed top-0 w-full z-50 bg-white/70 dark:bg-surface-container/70 backdrop-blur-xl border-b border-white/40 dark:border-outline-variant/20 shadow-sm transition-all duration-300">
                <div className="flex justify-between items-center px-margin-desktop py-4 max-w-container-max mx-auto">
                    <div className="text-headline-md font-headline-md font-bold tracking-tight text-primary dark:text-primary-fixed">
                        PalmCrest ENT
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="md:hidden p-2 text-primary" onClick={toggleMobileNav}>
                            <span className="material-symbols-outlined">menu</span>
                        </button>
                        <button 
                            onClick={handleBookClick}
                            className="btn-primary text-white px-6 py-2.5 rounded-full font-label-md text-label-md uppercase tracking-wider"
                        >
                            Book Appointment
                        </button>
                    </div>
                ...
                <div className="max-w-container-max mx-auto px-margin-desktop w-full relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button 
                                onClick={handleBookClick}
                                className="btn-primary text-white px-8 py-4 rounded-xl font-label-md text-label-md"
                            >
                                Book Appointment
                            </button>
                            <button className="bg-white/50 backdrop-blur-md border border-outline-variant/30 text-primary px-8 py-4 rounded-xl font-label-md text-label-md hover:bg-white transition-all">
                                Meet Specialists
                            </button>
                        </div>
                    </div>
            ...
            <section className="px-margin-desktop max-w-container-max mx-auto py-stack-lg reveal">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
                    <div className="md:col-span-7 rounded-3xl overflow-hidden glass-card h-[500px] relative group">
                        <img 
                            alt="Specialist"
                        ...
                        <div className="absolute bottom-8 left-8 text-white">
                            ...
                            <h3 className="font-headline-lg text-headline-lg">Dr. Elena Vance</h3>
                        </div>
                    </div>
                    <div className="md:col-span-5 flex flex-col gap-gutter">
                        <div className="glass-card p-8 rounded-3xl flex-1 flex flex-col justify-center">
                            <div className="w-12 h-12 bg-secondary-container rounded-full flex items-center justify-center mb-6">
                                <span className="material-symbols-outlined text-primary">biotech</span>
                            </div>
                            <h4 className="font-headline-md text-headline-md text-primary mb-4">Pioneering Technology</h4>
                            <p className="text-on-surface-variant">We utilize 3D endoscopy and robotic-assisted surgical systems to ensure the highest level of precision and minimal recovery times for our patients.</p>
                        </div>
                        <div className="glass-card p-8 rounded-3xl flex-1 flex flex-col justify-center">
                            <div className="w-12 h-12 bg-tertiary-fixed-dim rounded-full flex items-center justify-center mb-6">
                                <span className="material-symbols-outlined text-primary">verified_user</span>
                            </div>
                            <h4 class="font-headline-md text-headline-md text-primary mb-4">Patient-First Ethics</h4>
                            <p className="text-on-surface-variant">Personalized care plans tailored to your unique biological needs, ensuring comfort throughout your journey at PalmCrest.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="px-margin-desktop max-w-container-max mx-auto py-stack-lg reveal">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-headline-lg text-headline-lg text-primary mt-4">Specialized ENT Solutions</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                    {/* Ear Card */}
                    <div className="glass-card p-10 rounded-3xl hover:-translate-y-2 transition-transform duration-300">
                        <span className="material-symbols-outlined text-display text-secondary-container mb-6 block">hearing</span>
                        <h3 className="font-headline-md text-headline-md text-primary mb-4">Ear Care</h3>
                        <p className="text-on-surface-variant mb-6">Comprehensive diagnostics for hearing loss, tinnitus management, and advanced middle-ear microsurgery.</p>
                    ...
                    {/* Nose Card */}
                    <div className="glass-card p-10 rounded-3xl hover:-translate-y-2 transition-transform duration-300">
                        <span className="material-symbols-outlined text-display text-secondary-container mb-6 block">air</span>
                        <h3 className="font-headline-md text-headline-md text-primary mb-4">Nasal Health</h3>
                        <p className="text-on-surface-variant mb-6">Expert treatment for chronic sinusitis, allergic rhinitis, and functional rhinoplasty using minimally invasive techniques.</p>
                        <a className="text-secondary font-label-md flex items-center gap-2 hover:gap-4 transition-all" href="#">
                            Learn More <span className="material-symbols-outlined">arrow_forward</span>
                        </a>
                    </div>
                    {/* Throat Card */}
                    <div className="glass-card p-10 rounded-3xl hover:-translate-y-2 transition-transform duration-300">
                        <span className="material-symbols-outlined text-display text-secondary-container mb-6 block">voice_over_off</span>
                        <h3 className="font-headline-md text-headline-md text-primary mb-4">Throat &amp; Voice</h3>
                        <p className="text-on-surface-variant mb-6">Specialized care for vocal fold disorders, swallowing difficulties, and comprehensive head and neck oncology.</p>
                        <a className="text-secondary font-label-md flex items-center gap-2 hover:gap-4 transition-all" href="#">
                            Learn More <span className="material-symbols-outlined">arrow_forward</span>
                        </a>
                    </div>
            ...
            {/* About Section */}
            <section className="bg-surface-container-low py-stack-lg mt-stack-lg reveal">
                <div className="px-margin-desktop max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center">
                    <div className="relative">
                        ...
                        {/* Stat Badge */}
                        <div className="absolute -bottom-10 -right-10 glass-card p-8 rounded-2xl shadow-xl">
                            <p className="font-display text-display text-primary">25+</p>
                            <p className="font-label-md text-on-surface-variant">Years of Clinical Pedigree</p>
                        </div>
                    </div>
                    <div className="pl-0 md:pl-16">
                        <h2 className="font-display text-headline-lg text-primary mb-6">An Advanced Sanctuary of Care</h2>
                        ...
                        <ul className="space-y-4 mb-10">
                            <li className="flex items-start gap-4">
                                ...
                                <span className="text-on-surface">Board-certified specialists from world-renowned medical institutions.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="material-symbols-outlined text-on-tertiary-container">check_circle</span>
                                <span className="text-on-surface">Integrated digital health records for seamless patient journeys.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="material-symbols-outlined text-on-tertiary-container">check_circle</span>
                                <span className="text-on-surface">On-site surgical suites equipped with AI-assisted diagnostics.</span>
                            </li>
                        </ul>
                        <button className="bg-primary text-white px-8 py-4 rounded-xl font-label-md hover:bg-primary/90 transition-colors">
                            Our History
                        </button>
                    </div>
                </div>
            ...
            {/* Testimonials */}
            <section className="px-margin-desktop max-w-container-max mx-auto py-stack-lg reveal">
                <h2 className="font-headline-lg text-headline-lg text-primary text-center mb-16">Patient Stories</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
                    <div className="glass-card p-10 rounded-3xl relative">
                        <span className="material-symbols-outlined text-[64px] text-secondary/10 absolute top-4 right-8">format_quote</span>
                        <p className="text-body-lg text-on-surface-variant italic mb-8 relative z-10">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="font-bold text-primary">Sarah J. Lindquist</p>
                                <p className="text-caption text-on-surface-variant uppercase tracking-wider">Voice Specialist Patient</p>
                            </div>
                        </div>
                    </div>
                    <div className="glass-card p-10 rounded-3xl relative">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="font-bold text-primary">Robert McAllister</p>
                                <p className="text-caption text-on-surface-variant uppercase tracking-wider">Hearing Restoration Patient</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="mx-margin-desktop max-w-container-max md:mx-auto mb-stack-lg reveal">
                <div className="bg-primary-container rounded-[2rem] p-12 md:p-20 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10">
                    {/* Decorative Pattern */}
                    ...
                    <div className="relative z-10 text-white max-w-xl">
                        <span className="bg-error px-4 py-1 rounded-full text-caption font-bold uppercase tracking-widest mb-6 inline-block">24/7 Priority</span>
                        <h2 className="font-display text-display mb-6">Emergency ENT Portal</h2>
                        <p className="text-body-lg opacity-80">Acute ear trauma, sudden hearing loss, or airway emergencies require immediate specialist intervention. Our priority unit is standing by.</p>
                    </div>
                    <div className="relative z-10 flex flex-col gap-4 w-full md:w-auto">
                        <a 
                            className="bg-white text-primary px-10 py-6 rounded-2xl font-display text-headline-md flex items-center justify-center gap-4 hover:scale-105 transition-transform"
                        ...
                        <p className="text-white text-center opacity-60 font-label-md">Direct line to On-Call Specialists</p>
                    </div>
                </div>
            </section>
            ...
            <footer className="bg-surface-container-lowest dark:bg-surface-dim border-t border-outline-variant/30 w-full py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop max-w-container-max mx-auto">
                    <div className="col-span-1 md:col-span-1">
                        <div className="text-headline-sm font-headline-md text-primary dark:text-primary-fixed mb-6">PalmCrest ENT</div>
                        <p className="text-body-md text-on-surface-variant">The Advanced Sanctuary of Care. Leading the future of ENT medicine through innovation and empathy.</p>
                    </div>
                    <div>
                        <h4 className="font-label-md text-primary mb-6">Services</h4>
                    ...
                    <div>
                        <h4 className="font-label-md text-primary mb-6">Resources</h4>
                        <ul className="space-y-3">
                    ...
                    <div>
                        <h4 className="font-label-md text-primary mb-6">Contact</h4>
                        <p className="text-on-surface-variant mb-2">100 Clinical Way, Medical District</p>
                        <p class="text-on-surface-variant mb-4">info@palmcrestent.com</p>
                ...
                <div className="mt-12 pt-8 border-t border-outline-variant/10 px-margin-desktop max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-caption font-caption text-on-surface-variant">© 2024 PalmCrest ENT Hospital. Advanced Sanctuary of Care.</p>
            ...
            <div 
                id="mobile-nav"
                className={`fixed inset-0 bg-white z-[60] transform transition-transform duration-500 md:hidden ${
                    isMobileNavOpen ? 'translate-x-0' : 'translate-x-full'
                }`}
            >
                <div className="p-8 flex flex-col h-full">
                    <div className="flex justify-between items-center mb-12">
                        <span className="text-headline-md font-bold text-primary">PalmCrest</span>
                        <button className="p-2" onClick={toggleMobileNav}>
                            <span className="material-symbols-outlined">close</span>
                        </button>
                    </div>
                    <div className="flex flex-col gap-8">
                        <a className="text-display text-primary" href="#" onClick={toggleMobileNav}>Services</a>
                        <a className="text-display text-primary" href="#" onClick={toggleMobileNav}>Specialists</a>
                        <a className="text-display text-primary" href="#" onClick={toggleMobileNav}>Emergency</a>
                        <a className="text-display text-primary" href="#" onClick={toggleMobileNav}>Contact</a>
                    </div>
                    <div className="mt-auto">
                        <button 
                            onClick={() => { toggleMobileNav(); handleBookClick(); }}
                            className="w-full btn-primary text-white py-6 rounded-2xl text-headline-md"
                        >
                            Book Now
                        </button>
                    </div>
